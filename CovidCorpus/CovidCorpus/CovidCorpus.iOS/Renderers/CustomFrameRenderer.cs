...
namespace CovidCorpus.iOS.Renderers
{
    class CustomFrameRenderer : FrameRenderer
    {
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == nameof(Xamarin.Forms.Frame.CornerRadius) ||
                e.PropertyName == nameof(Xamarin.Forms.Frame))
            {
                UpdateCornerRadius();
            }
        }
